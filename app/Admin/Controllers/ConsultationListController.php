...
class ConsultationListController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Consultation_list';
    ...
    {
        $grid = new Grid(new Consultation_list());
...
//        $grid->column('enable', __('Enable'));
    ...
    {
        $show = new Show(Consultation_list::findOrFail($id));
...
//                $tools->disableList();
    ...
    {
        $form = new Form(new Consultation_list());
