...
class SpaceWorkController extends AdminController
{
    /**
...
//        $grid->column('title_txt', __('Title txt'));
        $grid->column('before_file_name', __('Before file name'))->image();
        $grid->column('after_file_name', __('After file name'))->image();
...
//        $show->field('created_at', __('Created at'));
    ...
    protected function form()
    {
        ...
        $form->image('before_file_name', __('Before file name'))->help('圖片建議尺寸為: 535 x 353');
        $form->image('after_file_name', __('After file name'))->help('圖片建議尺寸為: 535 x 353');
